...
namespace Test.RaceCarSetup
{
    ...
    {
        public DiagnosticCarConfiguration(RaceTrack raceTrack, double fuelCapacity, double averageSpeed, double fuelConsumptionPerKm, int id = 0)
            : base(raceTrack, fuelCapacity, averageSpeed, fuelConsumptionPerKm, id)
        {
